...
.band_limits				= "Границы диап.", // MaxLen: 16 (with ':' + .on or .off)
.beep_volume				= "Громк. сигналов", // MaxLen: 16 (with ':' + -24..6 + 'dB')
.dmr_mic_gain				= "Усил. микр. DMR", // MaxLen: 16 (with ':' + -33..12 + 'dB')
.fm_mic_gain				= "Усил. микр. FM", // MaxLen: 16 (with ':' + 0..31)
.key_long				= "Длит. нажатия", // MaxLen: 11 (with ':' + x.xs fitted)
.key_repeat				= "Длит. повтора", // MaxLen: 11 (with ':' + x.xs fitted)
...
.scan_delay				= "Задержка скан.", // MaxLen: 16 (with ':' + 1..30 + 's')
...
.both					= "нач. и кон.", // MaxLen 16 (with ':' + .dmr_beep)
...
.talker					= "Вызывающий",
.dmr_ts_filter				= "Фильтр т-слот", // MaxLen: 12 (with ':' + settings: .on or .off)
...
.seconds				= "сек.",
.radio_info				= "О рации",
.temperature_calibration		= "Калиб. темп.",
.pin_code				= "Пин-код",
...
.battery_calibration			= "Калиб. аккум.",
.low					= "низк.",
.high					= "высок.",
.dmr_id					= "DMR ID",
...
.timeZone				= "Час. пояс",
.suspend				= "Пауза",
.pass					= "Пропуск", // For satellite screen
.elevation				= "Возв.",
.azimuth				= "Азим.",
.inHHMMSS				= "Через",
...
.auto_night				= "Авто ночн. реж.", // MaxLen: 16 (with .on or .off)
.dmr_rx_agc				= "АРУ в реж. DMR",
...
.brightness_night				= "Ночн. яркость", // MaxLen: 16 (with : + 0..100 + %)
...
.show_distance				= "Показ. расст.", // MaxLen 16 (with ':' + .on or .off)
